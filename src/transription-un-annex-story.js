export const storyLines = [
  ...
  'At that time and they were all waiting to get into these twenty they want to be one of the twenty people',
  ...
  'Is it so? Then we all run to Supra Transcendental Fire breathing Meditation from the Transcendental Meditation.',
